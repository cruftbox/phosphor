...
Technically, phosphor is a Matrix-style digital rain for Windows Terminal.

Half-width katakana, ASCII digits, and Latin letters fall in green-gradient columns, with ~5% of threads rendered in vivid random RGB colors.
